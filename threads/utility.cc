// utility.cc 
// Debugging routines. Allows users to control whether to print DEBUG statements, based
...
//----------------------------------------------------------------------------------------
// DEBUG
// Print a debug message, if flag is enabled. Like printf, only with an extra argument
// on the front.
//----------------------------------------------------------------------------------------
