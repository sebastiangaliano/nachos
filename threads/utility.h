...
// controllable from the command line arguments passed to Nachos (-d). You are encouraged
// to add your own debugging flags. The pre-defined debugging flags are:
//
...
//
// New debugging flags added:
//
//      'j' -- thread join method
//      'p' -- port (synchronic mechanism)
//      'y' -- syscalls implementations
//
...
// This declares the type "VoidFunctionPtr" to be a "pointer to a function taking a
// pointer argument and returning nothing".  With such a function pointer (say it is
// "func"), we can call it like this:
//
// func (arg);
// or
// (*func) (arg);
//
// This is used by Thread::Fork and for interrupt handlers, as well as a couple of
// other places.
...
//----------------------------------------------------------------------------------------
// ASSERT
// If condition is false,  print a message and dump core. Useful for documenting
// assumptions in the code.
//
// NOTE: needs to be a #define, to be able to print the location where the error
// occurred.
//----------------------------------------------------------------------------------------
